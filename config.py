...
DEFAULT_SCHEDULE = {
    'Понедельник': {
        '1.1': 'Вася', '1.2': 'Дима Ч', '1.3': 'Айлар', '1.4': 'Егор',
        '1.5': 'Илья', '1.6': 'Даша', '1.7': 'Виталий', '1.8': 'Тимур'
    },
    'Вторник': {
        '1.1': 'Вася', '1.2': 'Дима Ч', '1.3': 'Айдан', '1.4': 'Дима А',
        '1.5': 'Тимур', '1.6': 'Рома', '1.7': 'Костя', '1.8': 'Леша Б'
    },
    'Среда': {
        '1.1': 'Дима Ч', '1.2': 'Илья', '1.3': 'Тимур', '1.4': 'Костя',
        '1.5': 'Катя', '1.6': 'Артем', '1.7': 'Рома', '1.8': 'Марк'
    },
    'Четверг': {
        '1.1': 'Вася', '1.2': 'Дима Ч', '1.3': 'Толя', '1.4': 'Глеб',
        '1.5': 'Тимур', '1.6': 'Рома', '1.7': 'Леша Б', '1.8': 'Марк'
    },
    'Пятница': {
        '1.1': 'Вася', '1.2': 'Дима Ч', '1.3': 'Айлар', '1.4': 'Егор',
        '1.5': 'Илья', '1.6': 'Даша', '1.7': 'Виталий', '1.8': 'Тимур'
